...
import { Clock, Delete, Edit, ExternalLink, Trash } from "lucide-react";
    ...
    <div className="flex items-center justify-between px-6 py-5 border-b border-neutral-800 last:border-b-0">
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          className="rounded-md border border-neutral-800 px-3 py-2 text-sm text-neutral-200 hover:bg-neutral-800 transition"
        >
          <ExternalLink size={18} />
        </a>
        <button
          onClick={onEdit}
          className="rounded-md border border-neutral-800 px-3 py-2 text-sm text-neutral-200 hover:bg-neutral-800"
        >
          <Edit size={18} />
        </button>
        ...
        <button
          onClick={onDelete}
          className="rounded-md border border-red-900 bg-red-950 px-3 py-2 text-sm text-red-400 hover:bg-red-900/40"
        >
          <Trash size={18} />
        </button>
      </div>
